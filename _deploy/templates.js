angular.module('NoteFire').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('js/directives/footer.html',
    ...
    "  <div class=\"container\">\n" +
    "    <small>NoteFire created by <a href=\"https://twitter.com/bobzurad\">Bob Zurad</a> and powered by <a href=\"https://github.com/firebase/angularfire\">AngularFire</a></small>\n" +
    "  </div>\n" +
    "</footer>\n"
  );
  ...
  $templateCache.put('js/directives/navbar.html',
    ...
    "        <li class=\"nav-item\">\n" +
    "          <a id=\"newNoteLink\" href=\"#/new\" class=\"nav-link navbar-link\" title=\"New Note\" style=\"display: none;\">\n" +
    ...
    "        </li>\n" +
    "        <li class=\"nav-item\">\n" +
    "          <a href=\"#/logout\" class=\"nav-link navbar-link isAuthenticated\" title=\"Logout\" style=\"display: none;\">\n" +
  ...
  $templateCache.put('js/templates/add-note.html',
    ...
    "      </div>\n" +
    "      <div class=\"col-3 d-flex justify-content-end padding-right-0\">\n" +
    "        <button id=\"newNoteTitleButton\" class=\"btn btn-primary saveButton\" type=\"submit\">\n" +
    ...
    "        <button id=\"saveButton\" class=\"btn btn-primary saveButton\" type=\"submit\">\n" +
    "          <span class=\"saveButtonText\">Save Note</span>\n" +
    "          <span class=\"saveButtonIcon\" style=\"display: none;\">\n" +
    "            <i class=\"fa fa-spinner fa-pulse fa-lg\"></i>\n" +
    "            <span class=\"sr-only\">Saving...</span>\n" +
  ...
  $templateCache.put('js/templates/edit-note.html',
    ...
    "      </div>\n" +
    "      <div class=\"col-3 d-flex justify-content-end padding-right-0\">\n" +
    "        <button id=\"editNoteTitleButton\" type=\"submit\" class=\"btn btn-primary saveButton\">\n" +
    "          <span class=\"saveButtonText\">Save Note</span>\n" +
    "          <span class=\"saveButtonIcon\" style=\"display: none;\">\n" +
    "            <i class=\"fa fa-spinner fa-pulse fa-lg\"></i>\n" +
    "            <span class=\"sr-only\">Saving...</span>\n" +
    ...
    "      </div>\n" +
    "      <div class=\"col-6 d-flex justify-content-end padding-right-0\">\n" +
