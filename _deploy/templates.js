angular.module('NoteFire').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('js/templates/add-note.html',
    ...
    "\n" +
    "    <input id=\"title\" type=\"text\" ng-model=\"addNoteCtrl.note.title\" class=\"form-control\"\r" +
    "\n" +
    ...
    "  <fieldset class=\"form-group\">\r" +
    "\n" +
    "    <button id=\"saveButton\" class=\"btn btn-primary pull-xs-right\" type=\"submit\">\r" +
    "\n" +
    "      <span id=\"saveButtonText\">Save Note</span>\r" +
    "\n" +
    "      <span id=\"saveButtonIcon\" style=\"display: none;\">\r" +
    "\n" +
  ...
  $templateCache.put('js/templates/edit-note.html',
    ...
    "    <div class=\"col-xs-6\">\r" +
    "\n" +
    "      <button id=\"saveButton\" type=\"submit\" class=\"btn btn-primary pull-xs-right\">\r" +
    "\n" +
    "        <span id=\"saveButtonText\">Save Note</span>\r" +
    "\n" +
    "        <span id=\"saveButtonIcon\" style=\"display: none;\">\r" +
  ...
  $templateCache.put('js/templates/home.html',
    "<div ng-repeat=\"note in homeCtrl.notes | orderBy:'-dateCreated'\">\r" +
    "\n" +
  ...
  $templateCache.put('js/templates/public.html',
    ...
    "\r" +
    "\n" +
    "<div ng-repeat=\"note in publicCtrl.notes | orderBy:'-dateCreated'\">\r" +
    "\n" +
